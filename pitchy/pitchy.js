...
var i = class {
    ...
    constructor(t, r) {
        ...
        this._inputLength = t, this._fft = new B(y(2 * t)), this._bufferSupplier = r, this._paddedInputBuffer = this._bufferSupplier(this._fft.size), this._transformBuffer = this._bufferSupplier(2 * this._fft.size), this._inverseBuffer = this._bufferSupplier(2 * this._fft.size)
    }
    get inputLength() {
...
function g(s, t) {
    let [r, f, e] = [s - 1, s, s + 1], [n, u, o] = [t[r], t[f], t[e]], h = n / 2 - u + o / 2, _ = -(n / 2) * (f + e) + u * (r + e) - o / 2 * (r + f), d = n * f * e / 2 - u * r * e + o * r * f / 2, l = -_ / (2 * h), c = h * l * l + _ * l + d;
    return [l, c]
}
var a = class {
    _autocorrelator;
...
export {
    i as Autocorrelator, a as PitchDetector
};
